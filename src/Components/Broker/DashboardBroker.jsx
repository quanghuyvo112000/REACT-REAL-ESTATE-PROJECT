...
import GetTransaction from './Content/getTransaction';
...
const DashboardBroker = () => {
    ...
    useEffect(() => {
        ...
        if (decryptedRole !== "BROKER" || sessionStorage.getItem('token') === null) {
            navigate('*');
        ...
        <div>
            ...
            <div class="p-4 sm:ml-64">
                <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
                    ...
                    {selectedComponent === 'products' && <GetContent />}
                    {selectedComponent === 'billing' && <GetTransaction />}
