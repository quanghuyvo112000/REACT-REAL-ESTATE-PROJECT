...
const DashboardContent = () => {
    ...
    const handleDelete = (appointmentId) => {
        fetch(BASE_URL + 'appointment/' + appointmentId, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${token}`
            }
            ...
            {loading ? (
                ...
                <div className="overflow-x-auto">
                    ...
                    <table className="min-w-full">
                        <thead>
                            <tr>
                                <th className="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Seller Name</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {currentAppointments.map(appointment => (
                                <tr key={appointment.id}>
                                    <td className="px-6 py-4 text-left whitespace-no-wrap">{appointment.nameSeller}</td>
