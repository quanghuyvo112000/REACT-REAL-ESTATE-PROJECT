...
import FormUpdateProduct from './FormFunction/FormUpdateProduct'

const ProductsContent = ({ callApi }) => {
        ...
        <div>
            <div className="header-ProductsContent w-full">
                <div className="flex justify-end ">
                    <button onClick={toggleModal} type="button" class="text-white  bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-primary-600  dark:hover:dark:bg-primary-700  focus:outline-none dark:focus:dark:bg-primary-800 ">New Eeal Estate</button>
                </div>
                {isModalOpen && (
                        ...
                        <div class="relative p-4 w-[50%] max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5">
                                    <FormUpdateProduct callApi={callApi} />
                                </div>
                            </div>
                        </div>
                    </div>
