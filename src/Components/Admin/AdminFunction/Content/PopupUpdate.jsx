...
const PopupUpdate = ({ data, callApi }) => {
    ...
    return (
        <div>
            <p onClick={toggleModal} className="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 my-2 ml-4 cursor-pointer"
                type="button">
                Edit product
            </p>
                    ...
                    <div class="relative p-4 w-[50%] max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5">
                                <FormUpdateProduct data={data} callApi={callApi} />
                            </div>
                        </div>
                    </div>
                </div>
